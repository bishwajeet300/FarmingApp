...
import com.farmingapp.model.TerraceFieldSubMainSelectionDesignUserModel
...
class TerraceFieldSubMainSelectionDesignViewModel @Inject constructor(
    ...
    fun receiveUserAction(action: UserAction<TerraceFieldSubMainSelectionDesignUserModel>) {
        when (action) {
